...
import center from '@/views/center'
    import danweirenzheng from '@/views/modules/danweirenzheng/list'
    ...
    import xuqiuzhengji from '@/views/modules/xuqiuzhengji/list'
