<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">面向企事业单位的项目申报小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.faren" class="input" type="text" placeholder="法人">
			   </div>
			 </div> -->
			<el-form-item label="法人" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.faren" autocomplete="off" placeholder="法人"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
