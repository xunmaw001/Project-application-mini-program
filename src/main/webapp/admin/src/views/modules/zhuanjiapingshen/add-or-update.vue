<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="评审时间" prop="pingshenshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.pingshenshijian" 
                type="datetime"
                :readonly="ro.pingshenshijian"
                placeholder="评审时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pingshenshijian" label="评审时间" prop="pingshenshijian">
              <el-input v-model="ruleForm.pingshenshijian" 
                placeholder="评审时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="评审结果" prop="pingshenjieguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="评审结果"
                  v-model="ruleForm.pingshenjieguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.pingshenjieguo" label="评审结果" prop="pingshenjieguo">
                    <span>{{ruleForm.pingshenjieguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	qiyedizhi : false,
	qiyemingcheng : false,
	pingshenshijian : false,
	pingshenneirong : false,
	pingshenjieguo : false,
      },
      ruleForm: {
        shenbaozhuti: '',
        shenbaotupian: '',
  ...
  created() {
	this.ruleForm.pingshenshijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiyemingcheng = true;
          ...
          if(o=='pingshenshijian'){
            this.ruleForm.pingshenshijian = obj[o];
	    this.ro.pingshenshijian = true;
            continue;
          }
	    ...
	    this.ro.pingshenneirong = true;
          ...
          if(o=='pingshenjieguo'){
            this.ruleForm.pingshenjieguo = obj[o];
	    this.ro.pingshenjieguo = true;
            continue;
          }
        }
      }
