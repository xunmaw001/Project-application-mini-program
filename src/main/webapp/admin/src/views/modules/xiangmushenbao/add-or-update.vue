<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申报主题" prop="shenbaozhuti">
          <el-input v-model="ruleForm.shenbaozhuti" 
              placeholder="申报主题" clearable  :readonly="ro.shenbaozhuti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申报主题" prop="shenbaozhuti">
              <el-input v-model="ruleForm.shenbaozhuti" 
                placeholder="申报主题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shenbaotupian" label="申报图片" prop="shenbaotupian">
          <file-upload
          tip="点击上传申报图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.shenbaotupian?ruleForm.shenbaotupian:''"
          @change="shenbaotupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shenbaotupian" label="申报图片" prop="shenbaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shenbaotupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申报项目" prop="shenbaoxiangmu">
          <el-input v-model="ruleForm.shenbaoxiangmu" 
              placeholder="申报项目" clearable  :readonly="ro.shenbaoxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申报项目" prop="shenbaoxiangmu">
              <el-input v-model="ruleForm.shenbaoxiangmu" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主体" prop="zhuti">
          <el-input v-model="ruleForm.zhuti" 
              placeholder="主体" clearable  :readonly="ro.zhuti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主体" prop="zhuti">
              <el-input v-model="ruleForm.zhuti" 
                placeholder="主体" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="其他" prop="qita">
          <el-input v-model="ruleForm.qita" 
              placeholder="其他" clearable  :readonly="ro.qita"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="其他" prop="qita">
              <el-input v-model="ruleForm.qita" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="评审状态" prop="pingshenzhuangtai">
          <el-select :disabled="ro.pingshenzhuangtai" v-model="ruleForm.pingshenzhuangtai" placeholder="请选择评审状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="评审状态" prop="pingshenzhuangtai">
	      <el-input v-model="ruleForm.pingshenzhuangtai"
                placeholder="评审状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="申报程序" prop="shenbaochengxu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="申报程序"
                  v-model="ruleForm.shenbaochengxu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shenbaochengxu" label="申报程序" prop="shenbaochengxu">
                    <span>{{ruleForm.shenbaochengxu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	shenbaozhuti : false,
	shenbaotupian : false,
	shenbaoxiangmu : false,
	zhuti : false,
	shenbaochengxu : false,
	...
	shhf : false,
      ...
      ruleForm: {
        ...
        qiyedizhi: '',
        qiyemingcheng: '',
       pingshenzhuangtai: '待评审',
        shhf: '',
      },
          pingshenzhuangtaiOptions: [],
      rules: {
          shenbaozhuti: [
                { required: true, message: '申报主题不能为空', trigger: 'blur' },
          ],
          shenbaotupian: [
          ],
          shenbaoxiangmu: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='shenbaozhuti'){
            this.ruleForm.shenbaozhuti = obj[o];
	    this.ro.shenbaozhuti = true;
            continue;
          }
          if(o=='shenbaotupian'){
            this.ruleForm.shenbaotupian = obj[o];
	    this.ro.shenbaotupian = true;
            continue;
          }
          if(o=='shenbaoxiangmu'){
            this.ruleForm.shenbaoxiangmu = obj[o];
	    this.ro.shenbaoxiangmu = true;
            continue;
          }
          if(o=='zhuti'){
	    ...
	    this.ro.zhuti = true;
          ...
          if(o=='shenbaochengxu'){
            this.ruleForm.shenbaochengxu = obj[o];
	    this.ro.shenbaochengxu = true;
            continue;
          }
          if(o=='shenbaoshijian'){
	    ...
	    this.ro.qiyemingcheng = true;
          ...
          if(o=='pingshenzhuangtai'){
            this.ruleForm.pingshenzhuangtai = obj[o];
	    this.ro.pingshenzhuangtai = true;
            continue;
          }
        }
      }
	...
	if(this.ruleForm.shenbaotupian!=null) {
		this.ruleForm.shenbaotupian = this.ruleForm.shenbaotupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    shenbaotupianUploadChange(fileUrls) {
	this.ruleForm.shenbaotupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
