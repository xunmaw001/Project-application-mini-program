<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="征集主题" prop="zhengjizhuti">
          <el-input v-model="ruleForm.zhengjizhuti" 
              placeholder="征集主题" clearable  :readonly="ro.zhengjizhuti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="征集主题" prop="zhengjizhuti">
              <el-input v-model="ruleForm.zhengjizhuti" 
                placeholder="征集主题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="征集对象" prop="zhengjiduixiang">
          <el-input v-model="ruleForm.zhengjiduixiang" 
              placeholder="征集对象" clearable  :readonly="ro.zhengjiduixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="征集对象" prop="zhengjiduixiang">
              <el-input v-model="ruleForm.zhengjiduixiang" 
                placeholder="征集对象" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="征集时间" prop="zhengjishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.zhengjishijian" 
                type="date"
                :readonly="ro.zhengjishijian"
                placeholder="征集时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhengjishijian" label="征集时间" prop="zhengjishijian">
              <el-input v-model="ruleForm.zhengjishijian" 
                placeholder="征集时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.zhengjitupian" label="征集图片" prop="zhengjitupian">
          <file-upload
          tip="点击上传征集图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.zhengjitupian?ruleForm.zhengjitupian:''"
          @change="zhengjitupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.zhengjitupian" label="征集图片" prop="zhengjitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhengjitupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="征集要求" prop="zhengjiyaoqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="征集要求"
                  v-model="ruleForm.zhengjiyaoqiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhengjiyaoqiu" label="征集要求" prop="zhengjiyaoqiu">
                    <span>{{ruleForm.zhengjiyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.zhengjishijian = this.getCurDate()
  ...
  methods: {
	...
	if(this.ruleForm.zhengjitupian!=null) {
		this.ruleForm.zhengjitupian = this.ruleForm.zhengjitupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xuqiuzhengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xuqiuzhengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    zhengjitupianUploadChange(fileUrls) {
	this.ruleForm.zhengjitupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
